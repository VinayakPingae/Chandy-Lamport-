...
/**
 * In this project, we rely on a controller to set a branchs initial balance and notify every branch of all other branches
 * in the distributed bank. This controller takes two command line inputs: the total amount of money in the distributed
