...
/**
 * Description - This class resumes to the part 1 of the code hence this will intialize all the branches and then it will transfer the money to the responding branches hence it
 * will all the branches to the transfer and generate the random integers.
 * @author Vinayak
 *
 */
